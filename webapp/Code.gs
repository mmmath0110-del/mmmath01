...
// ---------- 진입점 ----------
function doGet(e) {
  return json({ ok: true, app: '더블엠 근무일지 · 학원관리 API', version: SERVER_VERSION, academy: typeof ACADEMY_ACTIONS !== 'undefined', time: new Date().toISOString(), today: todayStr() });
}
